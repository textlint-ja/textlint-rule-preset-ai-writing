    ...
    invalid: [
        // Predicate + colon + block patterns that should be detected
        {
            ...
            errors: [
                {
                    message:
                        "「実行します:」のような述語とコロンで終わるパターンは、読み手によっては英語の構文を直訳したような印象を与える場合があります。「〜を説明します。」「次のように〜します。」のような自然な日本語表現を検討してください。"
                }
            ]
        },
        {
            ...
            errors: [
                {
                    message:
                        "「説明します:」のような述語とコロンで終わるパターンは、読み手によっては英語の構文を直訳したような印象を与える場合があります。「〜を説明します。」「次のように〜します。」のような自然な日本語表現を検討してください。"
                }
            ]
        },
        {
            ...
            errors: [
                {
                    message:
                        "「使用します:」のような述語とコロンで終わるパターンは、読み手によっては英語の構文を直訳したような印象を与える場合があります。「〜を説明します。」「次のように〜します。」のような自然な日本語表現を検討してください。"
                }
            ]
        },
        {
            ...
            errors: [
                {
                    message:
                        "「表示します:」のような述語とコロンで終わるパターンは、読み手によっては英語の構文を直訳したような印象を与える場合があります。「〜を説明します。」「次のように〜します。」のような自然な日本語表現を検討してください。"
                }
            ]
        },
        ...
        // 元々 ai-tech-writing-guideline にあったテストケースの移植
        {
            ...
            errors: [
                {
                    message:
                        "「例えば:」のような述語とコロンで終わるパターンは、読み手によっては英語の構文を直訳したような印象を与える場合があります。「〜を説明します。」「次のように〜します。」のような自然な日本語表現を検討してください。"
                }
            ]
        },
        {
            ...
            errors: [
                {
                    message:
                        "「JSXはJavaScriptの中でUIを記述するため、プログラマーにとって理解しやすいです：」のような述語とコロンで終わるパターンは、読み手によっては英語の構文を直訳したような印象を与える場合があります。「〜を説明します。」「次のように〜します。」のような自然な日本語表現を検討してください。"
                }
            ]
        }
    ]
